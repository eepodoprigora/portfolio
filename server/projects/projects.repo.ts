    ...
    return [
        {
            ...
            summary: tp('Корпоративный сайт инжиниринговой компании — серьёзная ниша, нестандартные анимации.')
        },
        {
            id: "rotormine",
            ...
            summary: tp('Маркетплейс люксовых часов — от Rolex до Patek Philippe. Каталог, фильтры, trade-in.')
        },
        {
            id: "khamovniki",
            ...
            summary: tp('Клубный дом де-люкс в Москве — иммерсивный промо-сайт для аудитории с бюджетом от 100 млн.')
        },
        {
            id: "obydenskiy",
            ...
            category: 'Luxury Real Estate',
            summary: tp('Клубный дом от Sminex в Хамовниках — pixel-perfect под де-люкс сегмент.')
        },
        {
            id: "dominanta",
            href: "https://d-a.ru/",
            ...
            summary: tp('Корпоративный сайт девелопера — мультипроектная витрина и кабинет брокера.')
        },
        {
            id: "iliynka",
            ...
            category: 'Luxury Real Estate',
            summary: tp('Клубные особняки в 160м от Кремля — один из самых дорогих адресов Москвы.')
        },
        {
            id: "whitemark",
            ...
            summary: tp('Сайт студии-победителя Awwwards и Webby Award. Два года внутри команды.')
        },
    ];
};